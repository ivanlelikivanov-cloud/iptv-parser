...
CATEGORY_MAP = {
    ...
    "sports": "Спорт", "sport": "Спорт", "kids": "Детские", "children": "Детские",
    "animation": "Детские", "music": "Музыка", "culture": "Познавательные",
    "documentary": "Познавательные", "education": "Познавательные",
    "science": "Познавательные", "travel": "Познавательные",
    "entertainment": "Развлекательные", "comedy": "Развлекательные",
    "lifestyle": "Развлекательные", "general": "Общие", "public": "Общие",
    "religious": "Общие", "radio": "Радио",
}
FEDERAL_NAMES = {"первый канал", "первый", "россия 1", "россия-1", "россия 2",
                 ...
                 "матч! тв", "мир", "звезда", "отр", "культура", "пятница", "ю",
                 "муз тв", "муз-тв", "спас", "царьград"}
KEYWORDS = {
    "Новости": ["новост", "вести", "news", "24", "инфо", "информац", "business",
                "деловая", "политика", "известия", "euronews", "bbc", "cnn"],
    "Спорт": ["спорт", "sport", "match", "матч", "футбол", "football", "хоккей",
              "hockey", "баскет", "теннис", "гонк", "ufc", "бокс", "khl", "биатлон"],
    "Кино и сериалы": ["кино", "film", "movie", "cinema", "сериал", "series", "комед",
                       "мелодрам", "боевик", "детектив", "ужас", "horror", "action",
                       "tv1000", "амедиа"],
    "Детские": ["детск", "kids", "kid", "cartoon", "мульт", "animation", "анимац",
                "юниор", "junior", "baby", "карусель", "disney", "аниме"],
    "Музыка": ["музык", "music", "муз", "mtv", "vh1", "hit", "hits", "шансон",
               "bridge", "рутв", "ru.tv"],
    "Познавательные": ["документ", "documentary", "discovery", "history", "история",
                       "наук", "science", "education", "образован", "nature", "природ",
...
REGION_WORDS = ("област", "край", "респуб", "округ", "район", "город", "регион",
                ...
                "минск", "беларусь", "алматы", "астана", "ташкент", "баку", "ереван")
API_CAT_MAP = [
...
def guess_category(item, custom_categories):
    ...
    if c:
        return c
    c = category_from_group(item.get("group", ""))
    if c:
        return c
    nl = clean_text(item.get("name", "")).lower()
