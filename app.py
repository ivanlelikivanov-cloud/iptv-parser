...
# ==================== ТОЛЬКО ПРОВЕРЕННЫЕ ИСТОЧНИКИ (120+) ====================
SOURCES = [
    # ===== IPTV-ORG (ОСНОВНЫЕ) =====
    ...
    # ===== АГРЕГАТОРЫ (РАБОТАЮЩИЕ) =====
    "https://m3u.su/m3u/ru.m3u",
    "https://m3u.su/m3u/sng.m3u",
    "https://new.m3u.su/m3u/ru.m3u",
    "https://new.m3u.su/m3u/sng.m3u",
...
def load_playlist():
    ...
    is_loading = True
    logger.info(f"🚀 НАЧАЛО ЗАГРУЗКИ ({len(SOURCES)} проверенных источников)")
    ...
    try:
        ...
        with ThreadPoolExecutor(max_workers=30) as executor:
            futures = {executor.submit(session.get, url, timeout=20, verify=False): url for url in SOURCES}
...
def home():
    ...
    <body>
        <div class="card">
            <h1>🇷🇺 IPTV Russia</h1>
            <div class="sub">🧠 PRO • 120+ проверенных источников</div>
...
if __name__ == '__main__':
    ...
    logger.info(f"🚀 Запуск PRO версии на порту {port}")
